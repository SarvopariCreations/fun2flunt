...
import homeHover from "../assets/images/explore-bold.svg";
    ...
    <header className="">
      <div className="w-full mx-auto px-6 py-3 flex justify-between items-center relative">
        ...
        <nav
          className={`${
            menuOpen
              ? "flex absolute top-16 left-0 w-full flex-col bg-gray-800 md:bg-transparent md:static z-10"
              : "hidden md:flex"
        ...
        >
          ...
          <NavItem icon={<img src={community} alt="Home" className="w-5 h-5" />}  hoverIcon={<img src={communityHover} alt="Home" className="w-5 h-5" />} label="Community" />
        </nav>
...
>
          ...
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white text-gray-900 rounded-md shadow-lg z-20">
...
function NavItem({ icon, hoverIcon, label }: NavItemProps) {
  ...
  return (
    <button
      className="flex items-center space-x-2 px-4 py-2 hover:bg-white hover:text-gray-900 rounded-full transition w-full md:w-auto"
