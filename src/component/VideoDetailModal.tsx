...
const VideoDetailModal: React.FC<VideoDetailModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="fixed inset-0 bg-[#000000ba] bg-opacity-50 transition-opacity bg-opacity-50 transition-opacity"
        aria-hidden="true"
      ></div>
      <div className="flex min-h-full items-center justify-center p-4 text-center">
        <div className="bg-white rounded-2xl shadow-lg w-[90%] max-w-full flex p-[24px] gap-[24px] relative relative shadow-xl w-max-[100px] flex flex-col md:flex-row">
          ...
          <div className="w-1/2 flex flex-col">
            ...
            {/* Description */}
            <p className="text-[#666666] text-[12px] mb-4 bg-[#F5F5F5] p-[8px] rounded-[8px] text-start">
              {description}{" "}
            ...
            {/* Prerequisite Skills */}
            <div className="mb-4">
              <div className="font-700 mb-2 text-start">
